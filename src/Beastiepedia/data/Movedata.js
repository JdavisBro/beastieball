...
MOVE_DATA.set("???", {
  ...
  .set("desperate", {
    name: "Desperate Dive",
    desc:
      "Can hit without volleying. Feel 1 [sprStatus,12]STRESSED (becomes [sprStatus,10]TIRED).",
    type: Type.Spirit,
    power: 75,
  })
  .set("damagedattack", {
  ...
  .set("cut", {
    name: "Cut Shot",
    desc:
      "Only used from net. Auto-targets front row. Feel 2 [sprStatus,9]BLOCKED (POW x0.5).",
    type: Type.Spirit,
    power: 95,
  })
  .set("dare", {
    name: "Challenge",
    desc:
      "[sprIcon,0]POW[sprBoost,0] to target. [sprIcon,1]POW[sprBoost,0] to target.",
    type: Type.Spirit,
    power: 100,
  })
  .set("commit", {
  ...
  .set("rollshot", {
    name: "Roll Shot",
    desc:
      "Only used from net. Auto-targets back row. Ignores [sprStatus,9]BLOCKED.",
    type: Type.Mind,
    power: 80,
  })
  .set("dump", {
  ...
  .set("superquick", {
    name: "Super Quick",
    desc:
      "Only used from net. VOLLEY ball. [sprIcon,0]POW[sprBoost,1] to ally.",
    type: Type.Pass,
    power: null,
  })
  .set("heartpass", {
  ...
  .set("jazzpass", {
    name: "Perfect Pass",
    desc:
      "Only used from net VOLLEY ball. SHIFTs ally to front row. Ally feels 1 [sprStatus,8]JAZZED (POW x1.5).",
    type: Type.Pass,
    power: null,
  })
  .set("myheartpass", {
  ...
  .set("stresspass", {
    name: "Demanding Set",
    desc:
      "VOLLEY ball. [sprIcon,0][sprIcon,1][sprIcon,2]POW[sprBoost,1] to ally. Ally feels 1 [sprStatus,12]STRESSED (becomes [sprStatus,10]TIRED).",
    type: Type.Pass,
    power: null,
  })
  .set("feint", {
  ...
  .set("curse", {
    name: "Flex",
    desc:
      "[sprIcon,0]POW[sprBoost,0] to self. [sprIcon,0]DEF[sprBoost,0] to self.",
    type: Type.Support,
    power: null,
  })
  .set("rest", {
  ...
  .set("preblock", {
    name: "Hunker",
    desc:
      "[sprIcon,0][sprIcon,1][sprIcon,2]DEF[sprBoost,0] to self. Feel 1 [sprStatus,0]NERVOUS (can't move).",
    type: Type.Support,
    power: null,
  })
  .set("followme", {
  ...
  .set("wornout", {
    name: "Hex",
    desc:
      "Target feels 1 [sprStatus,5]WIPED (must bench). Feel 2 [sprStatus,5]WIPED (must bench).",
    type: Type.Support,
    power: null,
  })
  .set("tailwind", {
  ...
  .set("overthink", {
    name: "Overthink",
    desc:
      "[sprIcon,2]POW[sprBoost,2] to self. Feel 1 [sprStatus,12]STRESSED (becomes [sprStatus,10]TIRED).",
    type: Type.Support,
    power: null,
  })
  .set("lockon", {
  ...
  .set("lowattks", {
    name: "Jeer",
    desc:
      "[sprIcon,0]POW[sprBoost,3] to target. [sprIcon,2]POW[sprBoost,3] to target.",
    type: Type.Support,
    power: null,
  })
  .set("charm", {
  ...
  .set("construct", {
    name: "Build",
    desc:
      "Only used from back row. Build a WALL in front of self. -34 STAMINA.",
    type: Type.Support,
    power: null,
  })
  .set("fieldclear", {
  ...
  .set("libero", {
    name: "Hawkeye",
    desc:
      "Target feels 1 [sprStatus,9]BLOCKED (POW x0.5). [sprIcon,0][sprIcon,1][sprIcon,2]DEF[sprBoost,3] to self.",
    type: Type.Defence,
    power: null,
  })
  .set("defheal", {
  ...
  .set("protect", {
    name: "Shield",
    desc:
      "Feel 1 [sprStatus,4]TOUGH (shielded) + 2 [sprStatus,1]ANGRY (can't use support).",
    type: Type.Defence,
    power: null,
  })
  .set("allyprotect", {
    name: "Tough Talk",
    desc:
      "Ally feels 1 [sprStatus,4]TOUGH (shielded). Active team feels 2 [sprStatus,1]ANGRY (can't use support).",
    type: Type.Defence,
    power: null,
  })
  .set("bdefup", {
  ...
  .set("batonpass", {
    name: "High Five",
    desc:
      "TAG OUT with benched ally. Tranfer [sprBoost,2][sprBoost,5]BOOSTS to benched ally.",
    type: Type.Defence,
    power: null,
  })
  .set("lifepass", {
    name: "Torch Pass",
    desc:
      "-100 STAMINA. TAG OUT. Restores benched ally's stamina and [sprStatus,5]WIPED.",
    type: Type.Defence,
    power: null,
  })
  .set("powswitch", {
    name: "Smack",
    desc:
      "TAG OUT with benched ally. [sprIcon,0][sprIcon,1][sprIcon,2]POW[sprBoost,0] to benched ally.",
    type: Type.Defence,
    power: null,
  })
  .set("whirlwind", {
  ...
  .set("lock", {
    name: "Staredown",
    desc:
      "SHIFTs self to front row. Target feels [sprStatus,0]NERVOUS (can't move).",
    type: Type.Defence,
    power: null,
  })
  .set("threat", {
  ...
  .set("sting", {
    name: "Sting",
    desc:
      "Target feels 2 [sprStatus,10]TIRED (only basic actions). -20 STAMINA.",
    type: Type.Defence,
    power: null,
  })
  .set("stress", {
  ...
  .set("allnervous", {
    ...
    desc:
      "Only used from net. Every fielded player feels 1 [sprStatus,0]NERVOUS (can't move).",
    type: Type.Defence,
    power: null,
  })
  .set("noisytag", {
    name: "Dramatic Exit",
    desc:
      "TAG OUT. Benched ally feels 1 [sprStatus,3]NOISY (draws attacks) + 2 [sprStatus,1]ANGRY (can't use support).",
    type: Type.Defence,
    power: null,
  })
  .set("distraction", {
