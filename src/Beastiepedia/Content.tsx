...
export default function Content(props: Props): React.ReactNode {
    ...
    if (beastiedata) {
        return (
            <div className={props.sidebarvisible ? styles.content : `${styles.content} ${styles.contentwide}`}>
        ...
        return (
            <div className={props.sidebarvisible ? `${styles.content} ${styles.contentnotselected}` : `${styles.content} ${styles.contentnotselected} ${styles.contentwide}`}>
